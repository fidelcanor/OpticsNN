...
from scatter_net_double_convolution_train import forwardprop
from scatter_net_double_convolution_train import init_weights
from scatter_net_double_convolution_train import init_bias
...
def main(data,reuse_weights,output_folder,weight_name_save,weight_name_load,n_batch,numEpochs,lr_rate,lr_decay,num_layers,n_hidden,percent_val,kernel_size,kernel_no):
    ...
    for i in range(0,num_layers):
        if i == 0:
            ...
            weights.append(init_weights((kernel_size,kernel_no,kernel_no)))
            biases.append(init_bias(kernel_no))
        elif i==2:
...
if __name__=="__main__":
    ...
    parser.add_argument("--output_folder",type=str,default='results/4_Layer_TiO2_25Kernel_DoubleConvolution_5layers_850per/')
